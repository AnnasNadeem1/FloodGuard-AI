...
3. Go to the **Analyze** page.
4. Upload a flood-related image and add a text description.
5. Click **Analyze** to view the AI prediction.
6. Click **Save Result** to add it to your history.
